...
class SAKT_P2(KTStrategy):
    ...
    def run_model(self):
        ...
        model = SAKT_Model(dataset.num_q, dataset.num_a, dataset.num_b, **model_config).to(device)
...
class SAKT_Model(Module):
    ...
    '''
    def __init__(self, num_q, num_a, num_b, n, d, num_attn_heads, dropout):
        super().__init__()
        self.num_q = num_q
        self.num_a = num_a
        self.num_b = num_b
    ...
    def train_model(
        ...
        for i in range(1, num_epochs + 1):
            ...
            for data in train_loader:
                ...
                p, _ = self(q.long(), r.long(), qshft.long(), a.long(), b.long())
